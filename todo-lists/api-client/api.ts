...
export const Def0StateEnum = {
    Pending: 'PENDING',
    InProgress: 'IN-PROGRESS',
    Done: 'DONE'
} as const;

export type Def0StateEnum = typeof Def0StateEnum[keyof typeof Def0StateEnum];
...
export const ListsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listsPost: async (body?: Def1, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/lists/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ListsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listsGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Def1>>> {
         ...
         * @throws {RequiredError}
         */
        async listsPost(body?: Def1, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const ListsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listsGet(options?: RawAxiosRequestConfig): AxiosPromise<Array<Def1>> {
         ...
         * @throws {RequiredError}
         */
        listsPost(body?: Def1, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
export class ListsApi extends BaseAPI {
     ...
     * @memberof ListsApi
     */
    public listsPost(body?: Def1, options?: RawAxiosRequestConfig) {
